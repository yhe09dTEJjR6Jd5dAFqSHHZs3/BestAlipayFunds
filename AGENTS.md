...
任务模式 →ESC →AI停止活动 →退出任务模式 →恢复主界面

点击“自由” →隐藏主界面 →进入自由模式 →AI活动（键盘、鼠标） →AI认为需要睡觉 →AI停止活动 →退出自由模式 →恢复主界面 →AI睡觉 →AI认为需要停止睡觉 →AI停止睡觉 →隐藏主界面 →进入自由模式 →（以此类推）

自由模式 →ESC →AI停止活动 →退出自由模式 →恢复主界面
